...
Read `.claude/panels/core.md` first. It is always active.

Then load additional panels based on what is in scope:

| If scope includes…                  | Load                          |
|-------------------------------------|-------------------------------|
| `*.py` files or tests               | `.claude/panels/python.md`    |
| HTTP routes or HTMX                 | `.claude/panels/http-api.md`  |
| Templates, CSS, or static assets    | `.claude/panels/ui.md`        |
| LLM client / prompt construction    | `.claude/panels/ai-llm.md`    |
| Primary panel impasse only          | `.claude/panels/secondary.md` |
