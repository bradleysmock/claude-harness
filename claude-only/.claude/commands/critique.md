...
|----------------|-------|------|
| Any file | **Core** | `.claude/panels/core.md` |
| `app/**/*.py`, `tests/**/*.py` | **Python** | `.claude/panels/python.md` |
| `app/routes/**` | **HTTP/API** | `.claude/panels/http-api.md` |
| `app/templates/**`, `app/static/**` | **UI** | `.claude/panels/ui.md` |
| `app/clients/**` or any LLM invocation | **AI/LLM** | `.claude/panels/ai-llm.md` |
...
The Secondary panel (`.claude/panels/secondary.md`) is loaded on demand — only when the primary panels reach a genuine impasse that synthesis cannot resolve.
