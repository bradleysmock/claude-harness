---
description: Harvest recurring failure patterns from .harness/memory.db into .tickets/_learnings.md — $
---
...
Call `/Users/bradley/workspaces/claude-harness/harness-combined/context/helpers/parse-memory-findings.md` with the
...
Call `/Users/bradley/workspaces/claude-harness/harness-combined/context/helpers/candidate-learnings-flow.md` with the
