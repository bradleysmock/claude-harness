---
description: Iterate on the solution design before implementation. Manual escape hatch for additional r
---
...
`/Users/bradley/workspaces/claude-harness/harness-combined/context/spec-remediation.md`) to clear a *semantic*
