---
description: Re-derive solution.md from the current problem.md and requirements.md for an already-desig
---
...
Spawn the **critic subagent** (`subagent_type: critic`) with a design-phase brief (Phase: **design**, Ticket: **XXXX-<slug>**, Round: **1**), following `/Users/bradley/workspaces/claude-harness/harness-combined/context/critic-brief.md`. Revise `solution.md` based on its findings.
