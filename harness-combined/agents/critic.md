...
- **Ticket**: `XXXX-<slug>`
- **Panels**: optional. When the caller supplies it, it is the fully resolved active-panel list — skip your own detection and review exactly those panels. See `critic-brief.md` Step 1 for the field's full contract; `/problem` Phase 5 supplies it on every design-review spawn.
